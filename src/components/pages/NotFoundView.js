    ...
    return (
        <div className="min-h-screen bg-canvas flex flex-col items-center justify-center relative overflow-hidden">
            ...
            <div className="flex flex-col items-center text-center gap-8 z-10">
                ...
                <MagneticButton>
                    <Link href="/">
                        <button className="px-12 py-4 bg-gradient-btn text-btn-primary-foreground text-base font-bold rounded-lg shadow-glow hover:scale-110 transition-transform duration-300 cursor-pointer">
                            Return Home
                        </button>
                    </Link>
                </MagneticButton>
