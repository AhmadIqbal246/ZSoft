...
const LightPillar = ({
    ...
    `;
      ...
      void main() {
        ...
        vec3 finalCol = max(col * uIntensity, 0.0);
        float alpha = clamp(length(finalCol) * 2.5, 0.0, 1.0);
    ...
    return (
        <div
            ref={containerRef}
            className={`w-full h-full absolute top-0 left-0 bg-transparent ${className}`}
